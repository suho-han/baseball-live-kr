...
현재는 macOS에서 메뉴바와 작은 창으로 경기 상황을 확인하는 경험을 먼저 다듬고 있습니다. iOS와 watchOS 쪽 구현도 일부 포함되어 있지만, 실제 기기와 운영 흐름 검증 전까지는 추후 계획으로 구분합니다.
...
현재 실제로 확인한 주요 사용 흐름은 macOS 앱 기준입니다.
...
- iPhone에서 오늘 경기와 관심 경기를 빠르게 보는 화면 검증하기
- 위젯과 실시간 활동으로 경기 흐름을 바로 확인하는 경험 검증하기
- watchOS에서 핵심 경기 정보를 짧게 확인하는 흐름 검증하기
