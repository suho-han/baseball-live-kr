...
| Category | Sports |
| 향후 Support URL | `https://suhohan.kr/baseball-live-kr/support` |
| 향후 Privacy Policy URL | `https://suhohan.kr/baseball-live-kr/privacy` |
...
| Category | Sports |
| 향후 Developer website | `https://suhohan.kr` |
| 향후 Privacy policy | `https://suhohan.kr/baseball-live-kr/privacy` |
| 향후 Contact email | `support@suhohan.kr` 또는 별도 운영 메일 |
...
2. Future privacy/support/terms URLs are live under `suhohan.kr` before public release.
...
2. 향후 배포 단계에서 `suhohan.kr` 하위의 privacy, support, terms, landing URL을 공개한다.
