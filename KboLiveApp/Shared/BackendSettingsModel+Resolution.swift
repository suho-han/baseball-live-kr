...
extension BackendSettingsModel {
    ...
    nonisolated static func baseURLString(for preset: BackendPreset, defaults: UserDefaults) -> String? {
        ...
        case .staging:
            return environmentBaseURLString(
                named: KboLiveEnvironment.stagingBaseURLEnvironmentName,
                legacyName: KboLiveEnvironment.legacyStagingBaseURLEnvironmentName
            )
                ?? migratedDefaultsString(
                    defaults: defaults,
        ...
        case .production:
            return environmentBaseURLString(
                named: KboLiveEnvironment.productionBaseURLEnvironmentName,
                legacyName: KboLiveEnvironment.legacyProductionBaseURLEnvironmentName
            )
                ?? migratedDefaultsString(
                    defaults: defaults,
    ...
    nonisolated static var environmentBaseURLString: String? {
        environmentBaseURLString(
            named: KboLiveEnvironment.backendBaseURLEnvironmentName,
            legacyName: KboLiveEnvironment.legacyBackendBaseURLEnvironmentName
        )
    }
